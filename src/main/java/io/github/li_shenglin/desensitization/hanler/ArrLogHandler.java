 ...
 * @version 1.0
 */
public class ArrLogHandler extends AbsLogHandler {
    ...
    public ArrLogHandler(String[] keywords, Integer depth, Mask maskHandler) {
        this(keywords, depth, true, maskHandler);
    }

    public ArrLogHandler(String[] keywords, Integer depth, boolean ignoreCase, Mask maskHandler) {
        super(maskHandler);
